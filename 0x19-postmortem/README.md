...
* Status monitoring. Enable some uptime-monitoring service such as [UptimeRobot](https://github.com/Aysuarex/alx-system_engineering-devops/blob/master/0x19-postmortem/https:/uptimerobot.com) to alert instantly upon outage of the website.
